...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<p class="tribe-events-back">
		<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'Back to all Calendar %s', '%s Events plural label', 'the-events-calendar' ), $events_label_plural ); ?></a>
	</p>
	...
	<div id="tribe-events-footer">
		...
		<nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'the-events-calendar' ), $events_label_singular ); ?>">
			<ul class="tribe-events-sub-nav">
				<li class="tribe-events-nav-previous"><?php tribe_the_prev_event_link( '<span>&laquo;</span> Previous Shift' ) ?></li>
				<li class="tribe-events-nav-next"><?php tribe_the_next_event_link( 'Next Shift <span>&raquo;</span>' ) ?></li>
			</ul>
			<!-- .tribe-events-sub-nav -->
		</nav>
	</div>
